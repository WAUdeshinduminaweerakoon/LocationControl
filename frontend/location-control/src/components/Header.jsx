  ...
  return (
    <header className='flex items-center justify-between w-full h-16 sm:h-16 bg-gradient-to-r from-indigo-500 to-black '>
      <div className="flex items-center m-10 ">
        <Link to="/">
        <img src={logo} alt="Logo" className="w-auto h-12 rounded-full sm:h-10 md:h-15 lg:h-18 xl:h-22" />
        </Link>
        {/* TODO : add the logo boder */}
        <Link to ="/">
      ...
      <div className="flex items-center m-10 space-x-6"> 
            ...
            <Link to="/Device" className="text-white hover:text-gray-300">Device</Link>
